...
def test_return_list() -> list[int]:
    ...
    try: 
        ...
        assert isinstance(result1, list), f"Expected list, but got {type(result1)}" #checks if it's a list 
        test_pass += 1
    ...
    try:
        ...
        assert isinstance(result2, list), f"Expected list, but got {type(result2)}"
        test_pass += 1
    except AssertionError as e:
        print("Assertion Error:", e)
        test_fail+=1    
    ...
    try:    
        ...
        assert isinstance(result3, list), f"Expected list, but got {type(result3)}"
        test_pass += 1
    except AssertionError as e: 
        print("Assertion Error:", e)
        test_fail+=1
    ...
    try:   
        ...
        assert isinstance(result1, list), f"Expected list, but got {type(result1)}"
        test_pass += 1
    except AssertionError as e:
        print("Assertion Error:", e)
        test_fail+=1
    ...
    try:
        ...
        assert isinstance(result4, list), f"Expected list, but got {type(result4)}"
        test_pass += 1
    except AssertionError as e:
        print("Assertion Error:", e)
        test_fail+=1
    ...
    try:
        ...
        assert isinstance(result5, list), f"Expected list, but got {type(result5)}"
        test_pass += 1
    except AssertionError as e:
        print("Assertion Error:", e)
        test_fail+=1
    ...
    try:
        ...
        assert isinstance(result6, list), f"Expected list, but got {type(result6)}"
        test_pass += 1
    except AssertionError as e:
        print("Assertion Error:", e)
        test_fail+=1
